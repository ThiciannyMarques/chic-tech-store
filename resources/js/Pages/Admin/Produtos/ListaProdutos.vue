...
const AddProduto = async () => {
    ...
    for (const imagem of produtoImagem.value) {
...
<template>
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <el-dialog v-model="dialogVisible" :title="modoEdicao ? 'Editar produto' : 'Adicionar produto'" width="500"
            ...
            <form class="max-w-md mx-auto" @submit.prevent = "AddProduto()" >
                ...
                <!-- <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input v-model="publicado" type="publicado" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                            name="floating_publicado" id="floating_publicado"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_publicado"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Publicação</label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
                        <input v-model="emEstoque" type="text" name="floating_emEstoque" id="floating_emEstoque"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_emEstoque"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Em
                            Estoque</label>
                    </div>
                </div> -->
                <div class="relative z-0 w-full mb-5 group">
                    <label for="floating_descricao" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descrição</label>
                    <textarea v-model="descricao" name="floating_descricao" id="floating_descricao" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                </div>
                <button type="submit"
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            produto.titulo }}</th>
                                <td class="px-4 py-3">{{ produto.categoria_id }}</td>
                                <td class="px-4 py-3">{{ produto.marca_id }}</td>
                                <!-- <td class="px-4 py-3">{{  produto.descricao }}</td> -->
                                <td class="px-4 py-3">{{ produto.quantidade }}</td>
                                <td class="px-4 py-3">{{ produto.emEstoque }}</td>
                                <td class="px-4 py-3">{{ produto.publicacao }}</td>
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <button @click="abrirEdicaoModal(produto)"
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Editar</button>
                                            </li>
                                        </ul>
                                        <div class="py-1">
                                            <a href="#"
