	...
	<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
		<el-dialog v-model="modalAberta" :title="modoEdicao ? 'Editar product' : 'Adicionar product'" width="500"
			...
			<form class="max-w-md mx-auto"  @submit.prevent="modoEdicao ? editarproduct() : Addproduct()">
				...
				<div class="relative z-0 w-full mb-5 group">
					<input v-model="price" v-type="price" name="floating_price" id="floating_price"
						class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
						placeholder=" " required />
				...
				<div class="relative z-0 w-full mb-5 group">
					<input v-model="quantity" type="text" name="floating_quantity" id="floating_quantity"
						class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
						placeholder=" " required />
				...
				<div class="relative z-0 w-full mb-5 group">
					...
					<textarea v-model="description" name="floating_description" id="floating_description" rows="4"
				...
				<div class="grid grid-cols-4 gap-4 mb-5">
					<div class="relative" v-for="(imageUrl, index) in product_images" :key="imageUrl.id">
						<img class="rounded w-24 h-24" :src="`/${imageUrl.image}`" alt="Large avatar">
						<button @click="excluirimageEdicao(imageUrl, index)" type="button"
				...
				<div class="overflow-x-auto">
					<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
						<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
							<tr>
								<th scope="col" class="px-4 py-3">name de product</th>
							...
							<tr v-for="product in products" :key="product.id" class="border-b dark:border-gray-700">
								...
								<td class="px-4 py-3 flex items-center justify-end">
									...
									<div :id="`${product.id}`"
										...
										<div class="py-1">
											<a href="#" @click="excluirproduct(product, index)"
...
const abrirEdicaoModal = (product) => {
...
const excluirproduct = (product, id) => {
	Swal.fire({
